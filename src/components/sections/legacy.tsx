...
export function Legacy() {
  return (
    <Section id="legacy" className="bg-slate-950 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-center relative z-10">
        ...
        >
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mt-4 leading-tight">
              A Heritage of <br />
              <span className="italic text-slate-400">Unwavering Trust</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 pt-8 border-t border-white/10">
            <div>
              <span className="block text-4xl font-serif font-bold text-gold-500 mb-2">20+</span>
              <span className="text-xs uppercase tracking-widest text-slate-400">Years of Excellence</span>
            </div>
            <div>
              <span className="block text-4xl font-serif font-bold text-gold-500 mb-2">$50B+</span>
              <span className="text-xs uppercase tracking-widest text-slate-400">Deal Value Advised</span>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="aspect-square bg-slate-800 p-8 md:p-12 border border-white/5 relative">
            ...
            <blockquote className="h-full flex flex-col justify-center">
              <p className="text-2xl md:text-3xl font-serif italic text-slate-200 leading-relaxed mb-8">
              ...
              <footer className="text-gold-500 font-semibold uppercase tracking-widest text-sm">
                — The Founders
              </footer>
            </blockquote>
          </div>
